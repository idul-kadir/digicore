...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Feb 2025 pada 23.56
...
--
-- Struktur dari tabel `l_hosting`
--

CREATE TABLE `l_hosting` (
  `id` int(11) NOT NULL,
  `kode_produk` varchar(30) NOT NULL,
  `id_user` varchar(20) NOT NULL,
  `tgl_expired` date NOT NULL,
  `perpanjang` enum('ya','tidak') NOT NULL,
  `status` set('aktif','tidak aktif','expired','suspend') NOT NULL,
  `keterangan` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL CHECK (json_valid(`keterangan`))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1732972064, 'OTP', '1732487217', 'KGVna6d4qKLfxbwgdqQBUtkbqhbAk1Nm1732972064834', '2024-12-30', 'tidak', 'expired'),
...
INSERT INTO `pesan` (`id`, `tujuan`, `pesan`, `id_produk`, `terkirim`, `status`, `keterangan`) VALUES
(1735179939, '6289669106718', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Itaque illum incidunt vel autem corrupti', '1732972515', 1735947551, 'sukses', 'server2.json'),
(1735180065, '6289669106718', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Itaque illum incidunt vel autem corrupti', '1732972515', 1735947581, 'sukses', 'server2.json'),
(1735180122, '6289669106718', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit.', '1732972515', 1735947642, 'sukses', 'server1.json'),
(1735180339, '6289669106718', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. testing', '1732972515', 1735947604, 'sukses', 'server1.json'),
(1735180518, '6289669106718', 'Lorem, ipsum dolor sit amet consectetur adipisicing elit.', '1732972515', 1735947665, 'sukses', 'server1.json');
...
('DIGI-BASIC', 'DIGI BASIC', 'Hosting', 45000, '[\"Berlaku 3 bulan\",\"Storage 3GB Dedicated\",\"Bandwith Unlimited\",\"2 Email\",\"2 Ftp Account\",\" 2 Database\",\"2 Sub Domain\"]', '[\"Dilarang spam email\",\" Ketahuan spam akan dibaned\"]', 90, 'aktif'),
('DIGI-ELITE', 'DIGI ELITE', 'Hosting', 85000, '[\"Berlaku 3 bulan\",\"Storage 8GB Dedicated\",\"Bandwith Unlimited\",\"3 Email\",\"3 Ftp Account\",\"3 Database\",\"3 Sub Domain\",\"Weekly backup\"]', '[\"Dilarang spam email\",\"Ketahuan spam akan dibaned\"]', 90, 'aktif'),
('DIGI-POWER', 'DIGI POWER', 'Hosting', 60000, '[\"Berlaku 3 bulan\",\"Storage 5GB Dedicated\",\"Bandwith Unlimited\",\"2 Email\",\"3 Ftp Account\",\"3 Database\",\"3 Sub Domain\"]', '[\"Dilarang spam email\",\"Ketahuan spam akan dibaned\"]', 90, 'aktif'),
...
INSERT INTO `tiket` (`id`, `id_user`, `judul`, `kategori`, `prioritas`, `deskripsi`, `lampiran`, `status`) VALUES
(1738476400, 1732487217, 'Tidak terkoneksi', 'Technical', 'Medium', 'Tidak terkoneksi', '', 'open');
...
INSERT INTO `user` (`id`, `nama`, `email`, `wa`, `password`, `saldo`, `aktifitas`) VALUES
(1732487217, 'Ridwan Kadir', '', '089669106718', '865a4f84143b1e26f0289fae728a62e9', 189000, '');
...
--
-- Indeks untuk tabel `l_hosting`
--
ALTER TABLE `l_hosting`
  ADD PRIMARY KEY (`id`);
